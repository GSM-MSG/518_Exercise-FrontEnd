    ...
    <div className={styles.home}>
      <div className={styles.home1}>
        ...
        <div className={styles.repeatText}>
          <span>
            {' '}
            - 5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 -
            5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 -
            5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 -
            5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 -
            5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 - 5.18 열흘 간의 항쟁 -
        ...
        <div className={styles.repeatText2}>
          <span>
      ...
      <div className={styles.home2}>
        ...
        <button onClick={locationStory} className={styles.toStoryBtn}>
          전개과정 보러가기
        </button>
      </div>
      ...
      <footer className={styles.homeFooter}>
        <ul className={styles.contactList}>
          ...
          <li>
            자료 출처 :{' '}
            <a href="http://photo.518.org/">
              5·18 사진 아카이브(http://photo.518.org/)
            </a>
          </li>
        </ul>
      </footer>
